...
def create_csv(root_dir, train_validation_split=0.8):
    """
    Create CSV data for training, validation and testing
    :param root_dir: directory where the data is stored
    :param train_validation_split: ratio of training to validation dataset
    :return: void
    """
    ...
    for lang in languages:
        ...
        test_set += zip(
            file_names[lang][num_train + num_validation:num_train + num_validation + num_test], itertools.repeat(label)
        )
